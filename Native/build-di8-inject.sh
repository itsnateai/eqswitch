...
MSYS_NO_PATHCONV=1 "$CL" /nologo /LD /O2 /W3 /DNDEBUG /EHsc \
    ...
    eqswitch-di8.cpp di8_proxy.cpp device_proxy.cpp key_shm.cpp iat_hook.cpp pattern_scan.cpp net_debug.cpp mq2_bridge.cpp login_state_machine.cpp login_givetime_detour.cpp eqmain_offsets.cpp eqmain_cxstr.cpp \
