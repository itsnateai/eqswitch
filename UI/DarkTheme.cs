...
public static class DarkTheme
{
    ...
    internal static readonly Font TabFontBold = new("Segoe UI Semibold", 9f, FontStyle.Bold);
    internal static readonly Font TabFontRegular = new("Segoe UI", 8.5f, FontStyle.Regular);
