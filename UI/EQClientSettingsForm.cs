...
public class EQClientSettingsForm : EqSwitchForm
{
    ...
    private void InitializeForm()
    {
        ...
        _nudMaxFPS = DarkTheme.AddCardNumeric(cardPerf, 78, cy, 50, Math.Clamp(_config.EQClientIni.MaxFPS, 0, EqClientIniSchema.MaxFpsCap), 0, EqClientIniSchema.MaxFpsCap);
        DarkTheme.AddCardLabel(cardPerf, "MaxBGFPS:", 245, cy + 2);
        _nudMaxBGFPS = DarkTheme.AddCardNumeric(cardPerf, 325, cy, 50, Math.Clamp(_config.EQClientIni.MaxBGFPS, 0, EqClientIniSchema.MaxFpsCap), 0, EqClientIniSchema.MaxFpsCap);
