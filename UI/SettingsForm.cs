...
public class SettingsForm : Form
{
    ...
    private TabPage BuildAccountsTab()
    {
        ...
        // ─── Quick Login Slots ───────────────────────────────────────
        y += 240;
        var slotsCard = DarkTheme.MakeCard(page, "\u26A1", "Quick Login Slots", DarkTheme.CardGold, 10, y, 480, 85);
        DarkTheme.AddCardLabel(slotsCard, "Slot 1:", 10, 28);
        _cboQuickLogin1 = DarkTheme.AddCardComboBox(slotsCard, 55, 25, 150, Array.Empty<string>());
        DarkTheme.AddCardLabel(slotsCard, "Slot 2:", 215, 28);
        _cboQuickLogin2 = DarkTheme.AddCardComboBox(slotsCard, 260, 25, 150, Array.Empty<string>());
        DarkTheme.AddCardLabel(slotsCard, "Slot 3:", 10, 54);
        _cboQuickLogin3 = DarkTheme.AddCardComboBox(slotsCard, 55, 51, 150, Array.Empty<string>());
        DarkTheme.AddCardLabel(slotsCard, "Slot 4:", 215, 54);
        _cboQuickLogin4 = DarkTheme.AddCardComboBox(slotsCard, 260, 51, 150, Array.Empty<string>());
        ...
        _lblSlotDuplicateWarn = DarkTheme.AddCardHint(slotsCard, "Bind to tray click actions or hotkeys below", 10, 70);
        ...
        // ─── Auto-Login Hotkeys ──────────────────────────────────────
        y += 93;
        var hkCard = DarkTheme.MakeCard(page, "\u2328", "Auto-Login Hotkeys", DarkTheme.CardGreen, 10, y, 480, 78);
        DarkTheme.AddCardLabel(hkCard, "Slot 1:", 10, 26);
        _txtAutoLogin1Hotkey = MakeHotkeyBox(hkCard, 55, 24);
        DarkTheme.AddCardLabel(hkCard, "Slot 2:", 160, 26);
        _txtAutoLogin2Hotkey = MakeHotkeyBox(hkCard, 205, 24);
        DarkTheme.AddCardHint(hkCard, "Press combo to set. Backspace = clear.", 290, 26);
        DarkTheme.AddCardLabel(hkCard, "Slot 3:", 10, 50);
        _txtAutoLogin3Hotkey = MakeHotkeyBox(hkCard, 55, 48);
        DarkTheme.AddCardLabel(hkCard, "Slot 4:", 160, 50);
        _txtAutoLogin4Hotkey = MakeHotkeyBox(hkCard, 205, 48);
        _lblAutoLoginHotkeyWarn = DarkTheme.AddCardHint(hkCard, "", 10, 68);
