...
| File | Size | Notes |
|------|------|-------|
| **EQSwitch.exe** | ~260 KB | Requires [.NET 8 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0) |
| **EQSwitch-standalone.exe** | ~171 MB | No runtime needed, click and go |
